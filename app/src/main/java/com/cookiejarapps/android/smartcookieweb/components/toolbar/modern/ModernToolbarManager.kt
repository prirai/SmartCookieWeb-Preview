...
class ModernToolbarManager(
    ...
    private var modernContextualToolbar: com.cookiejarapps.android.smartcookieweb.toolbar.ContextualBottomToolbar? =
        null
    ...
    private fun createModernContextualToolbar() {
        ...
        modernContextualToolbar =
            com.cookiejarapps.android.smartcookieweb.toolbar.ContextualBottomToolbar(container.context).apply {
                // Restore the listener to make buttons actually work
                listener = object :
                    com.cookiejarapps.android.smartcookieweb.toolbar.ContextualBottomToolbar.ContextualToolbarListener {
