...
class BrowserFragment : BaseBrowserFragment(), UserInteractionHandler {
    ...
    private var modernToolbarManager: com.cookiejarapps.android.smartcookieweb.components.toolbar.modern.ModernToolbarManager? =
        null
    ...
    private fun setupContextualBottomToolbar() {
        ...
        val toolbar =
            (browserToolbarView.integratedContextualToolbar as? com.cookiejarapps.android.smartcookieweb.toolbar.ContextualBottomToolbar)
        ...
        if (showBottomToolbar) {
            toolbar.listener = object : ContextualBottomToolbar.ContextualToolbarListener {
                ...
                override fun onMenuClicked() {
                    ...
                    val browserMenu =
                        com.cookiejarapps.android.smartcookieweb.components.toolbar.BrowserMenu(
                            context = context,
                            store = components.store,
                            onItemTapped = { item ->
    ...
    private fun initializeModernToolbarSystem() {
        ...
        try {
            ...
            modernToolbarManager =
                com.cookiejarapps.android.smartcookieweb.components.toolbar.modern.ModernToolbarManager(
    ...
    private fun applySimpleScrollBehaviorFix() {
        ...
        if (prefs.toolbarPosition == com.cookiejarapps.android.smartcookieweb.components.toolbar.ToolbarPosition.BOTTOM.ordinal && prefs.hideBarWhileScrolling) {
